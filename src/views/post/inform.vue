  ...
  <div>
    <b-modal id="modal-post-inform" size="lg" :title="getTitle" @ok="onSubmit">
      <div>
        ...
        <b-form-group label="제목" label-for="title" label-cols="2">
          <b-form-input
            id="title"
            v-model="post.title"
        ...
        <b-form-group label="내용" label-for="content" label-cols="2">
          <b-form-input
            id="content"
  ...
  methods: {
    onSubmit() {
      ...
      if (this.inputMode === 'insert') {
        ...
        this.$store.dispatch('actPostInsert', this.post) // 입력 실행
      }
      ...
      //   this.$store.dispatch('actPostUpdate', this.post) // 수정 실행
      // }
