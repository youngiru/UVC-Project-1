  ...
  <div id="join-2_wrap">
    <div class="join_container">
      ...
      <div class="join_check_box">
        <input id="join_all_check" v-model="checkAll" type="checkbox" name="join_all_check_na" />
        <label for="join_all_check">
          <span class="join_text_bold">우리들의 모든약관을 확인하고 전체 동의합니다</span>
          <span class="join_text_bgccc"> (전체동의, 선택항목도 포함됩니다.) </span>
        </label>
      </div>
      <div class="join_check_box">
        <input
          id="join_all_check_02"
          v-model="check.check1"
          type="checkbox"
          name="join_all_check_na_02"
          class="join_all"
        />
        <label for="join_all_check_02">
          <span class="join_text_bold">(필수)</span>
          이용약관
          <a href="#none">전체보기</a>
        </label>
        <div class="join_text_01">
          제1조(목적)<br />
          <br />
          표준약관 제10023호<br />
          <br />
          이 약관은 (주)남선지티엘 회사(전자거래 사업자)가 운영하는 청풍명월장터 사이버 몰(이하 "몰"이라 한다)에서
          제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을
          규정함을 목적으로 합니다.<br />
          ...
          제2조(정의)<br />
          <br />
          ① "몰"이란 (주)남선지티엘 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여
          ...
          이용자가 쉽게 알 수 있도록 "몰"의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을
          ...
          정보통신망이용촉진등에관한법률, 방문판매등에관한법률, 소비자보호법 등 관련법을 위배하지 않는 범위에서 이
          약관을 개정할 수 있습니다.<br />
          ④ "몰"이 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 몰의 초기화면에 그 적용일자
          7일이전부터 적용일자 전일까지 공지합니다.<br />
          ...
          개정약관 조항이 적용됩니다.<br />
          ⑥ 이 약관에서 정하지 아니한 사항과 이 약관의 해석에 관하여는 전자상거래등에서의 소비자보호에 관한 법률, 약관의
          규제 등에 관한 법률, 공정거래위원회가 정하는 전자상거래 등에서의 소비자보호지침 및 관계법령 또는 상관례에
          따릅니다.<br />
          <br />
          <br />
          제4조(서비스의 제공 및 변경)<br />
          ...
          ③ 사업종목의 전환, 사업의 포기, 업체간의 통합 등의 이유로 서비스를 제공할 수 없게 되는 경우에는 "몰"은 제8조에
          ...
          제13조(재화등의 공급)<br />
          <br />
          ① "몰"은 이용자와 재화등의 공급시기에 관하여 별도의 약정이 없는 이상, 이용자가 청약을 한 날부터 7일 이내에
          재화 등을 배송할 수 있도록 주문제작, 포장 등 기타의 필요한 조치를 취합니다. 다만, "몰"이 이미 재화 등의 대금의
          전부 또는 일부를 받은 경우에는 대금의 전부 또는 일부를 받은 날부터 2영업일 이내에 조치를 취합니다. 이때 "몰"은
          ...
          명기하거나 시용상품을 제공하는 등의 조치를 하지 않았다면 이용자의 청약철회등이 제한되지 않습니다.<br />
          ...
          때에는 지체없이 당해 결제수단을 제공한 사업자로 하여금 재화등의 대금의 청구를 정지 또는 취소하도록
          요청합니다.<br />
          ③ 청약철회등의 경우 공급받은 재화등의 반환에 필요한 비용은 이용자가 부담합니다. "몰"은 이용자에게 청약철회등을
          이유로 위약금 또는 손해배상을 청구하지 않습니다. 다만 재화등의 내용이 표시·광고 내용과 다르거나 계약내용과
          다르게 이행되어 청약철회등을 하는 경우 재화등의 반환에 필요한 비용은 "몰"이 부담합니다.<br />
          ④ 이용자가 재화등을 제공받을때 발송비를 부담한 경우에 "몰"은 청약철회시 그 비용을 누가 부담하는지를 이용자가
          알기 쉽도록 명확하게 표시합니다.<br />
          <br />
          <br />
          제17조(개인정보보호)<br />
          <br />
          ...
          또는 시·도지사가 의뢰하는 분쟁조정기관의 조정에 따를 수 있습니다.<br />
          <br />
          <br />
          제24조(재판권 및 준거법)<br />
          <br />
      ...
      <div class="join_check_box">
        <input
          id="join_all_check_03"
          v-model="check.check2"
          type="checkbox"
          name="join_all_check_na_03"
          class="join_all"
        />
        <label for="join_all_check_03">
          <span class="join_text_bold">(필수)</span>
          개인정보 수집 및 이용
          <a href="#none">전체보기</a>
        </label>
        <div class="join_text_02">
      ...
      <button class="join-2-btn"><router-link to="/auth/join">다음</router-link></button>
    </div>
  </div>
</template>
